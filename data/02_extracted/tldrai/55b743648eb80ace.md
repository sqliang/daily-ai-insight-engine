...
tldr: Sakana AI 发布了首款商用产品 Sakana Marlin，这是一款面向企业的自主研究助手，基于长期推理技术构建，可自主工作约8小时生成战略研究报告和摘要幻灯片。
objective_summary: Sakana AI 于2026年7月发布了其首款商用产品 Sakana Marlin。用户输入研究主题后，Marlin 通过对话精炼研究方向，随后自主进行假设提出、信息收集和验证，最终输出结构化摘要幻灯片和长达数十页的详细战略报告。该产品经过约300名来自金融、咨询和智库等行业的专业人士的封闭测试后正式上线，提供按量付费到
  Enterprise 等多种定价方案。
...
entities:
  ...
  key_people: []
key_logic_flow:
- Sakana AI 发布了其首款商用产品 Sakana Marlin，这是一款面向企业的自主研究助手，基于长期推理技术构建。
- 用户输入研究主题后，Marlin 通过对话精炼研究方向，随后自主进行假设提出、信息收集和验证，无需人工干预。
- Marlin 可自主工作最长约8小时，输出结构化摘要幻灯片和长达数十页的详细战略研究报告。
- 该产品经过了约300名来自金融机构、事业公司、咨询公司和智库的专业人士的封闭测试。
- Sakana Marlin 整合了 Sakana AI 此前在 AI Scientist、AB-MCTS 和 ALE-Agent 等研究项目中的技术积累。
- 产品提供按量付费（Pay per use）、Pro、Team 和 Enterprise 等多种定价方案，用户可自助即日使用。
extract_result: success
object_mentions:
- object_type: product
  name: Sakana Marlin
  canonical_name: Sakana Marlin
  url: https://sakana.ai/marlin
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - Sakana AI 发布了其首款商用产品 Sakana Marlin，这是一款面向企业的自主研究助手。
  - 用户输入研究主题后，Marlin 可自主工作最长约8小时，生成结构化摘要幻灯片和数十页的详细研究报告。
  - 该产品经过约300名专业人士的封闭测试，提供从按量付费到 Enterprise 的多种定价方案。
  article_id: 55b743648eb80ace
- object_type: project
  name: AI Scientist
  ...
  evidence_snippets:
  - Sakana AI 此前发布的 AI Scientist 项目实现了从创意生成到同行评审的研究流程自动化。
  - AI Scientist 的研究成果已被 Nature 杂志收录，其技术为 Sakana Marlin 的高级研究能力提供了支撑。
  article_id: 55b743648eb80ace
- object_type: project
  name: AB-MCTS
  canonical_name: AB-MCTS
  url: null
  confidence: medium
  article_role: mentioned_reference
  evidence_snippets:
  - AB-MCTS 是 Sakana AI 提出的多模型协作推理技术，用于提升模型的推理能力。
  - AB-MCTS 等长期推理和多模型优化控制技术为 Sakana Marlin 的自主研究能力奠定了基础。
  article_id: 55b743648eb80ace
- object_type: project
  name: ALE-Agent
  canonical_name: ALE-Agent
  url: null
  confidence: medium
  article_role: mentioned_reference
  evidence_snippets:
  - ALE-Agent 是 Sakana AI 开发的用于自动化算法工程的技术项目。
  - ALE-Agent 等研究积累为 Sakana Marlin 自主执行复杂工作流的能力提供了技术基础。
  article_id: 55b743648eb80ace
---
