...
tldr: Apple 起诉 OpenAI，指控其通过挖角 Apple 前员工 Tang Tan 和 Chang Liu 窃取商业机密，用于开发与 iPhone 竞争的硬件产品。
objective_summary: Apple 于 2026 年 7 月 10 日向加州北区联邦地区法院提起诉讼，指控 OpenAI 及其高级硬件主管 Tang
  Tan 和前高级系统电气工程师 Chang Liu 窃取商业机密、违反合同。Apple 称 Tang Tan 在招聘过程中使用 Apple 机密项目代号并引导离职员工规避安全流程，Chang
  Liu 则未归还 Apple 笔记本并下载了机密技术文档。Apple 表示 2 月曾发函但未获回应，要求法院禁止 OpenAI 使用其商业机密并归还材料。OpenAI
  事后回应称无意窃取其他公司的商业机密。
...
entities:
  ...
  - Ming-Chi Kuo
key_logic_flow:
- Apple 在加州北区联邦地区法院起诉 OpenAI，指控其窃取商业机密和违反合同。
- Apple 指控 OpenAI 高级硬件主管 Tang Tan 在招聘中使用 Apple 的机密项目代号，要求应聘者携带 Apple 硬件组件参加面试，并指导离职员工如何规避安全流程。
- Apple 指控前高级系统电气工程师 Chang Liu 在 2026 年加入 OpenAI 后未归还 Apple 的笔记本电脑，并使用该电脑下载了包含未发布技术规格和工程演示的机密文档。
- Tang Tan 在 Apple 任职 24 年，离职前担任 iPhone 和 Apple Watch 的产品设计副总裁；Chang Liu 在 Apple 工作了
  8 年。
- Jony Ive 的硬件初创公司 io 于 2025 年被 OpenAI 以 65 亿美元收购，被诉文件中提及 io 但未涉及 Jony Ive 本人。
- 产业分析师郭明錤 4 月曾暗示 OpenAI 的硬件可能是一款依赖 AI 代理而非应用的智能手机，将对 Apple 核心硬件业务构成重大威胁。
extract_result: success
object_mentions:
- object_type: company
  name: io
  canonical_name: io (Jony Ive's device startup)
  url: null
  confidence: high
  article_role: mentioned_reference
  evidence_snippets:
  - Apple 前首席设计师 Jony Ive 的硬件初创公司 io 于 2025 年被 OpenAI 以 65 亿美元收购，以帮助 OpenAI 实现其硬件野心。
  - 被诉文件中提到了 io 的名字，但 Jony Ive 本人未被列为诉讼对象。
  article_id: fffa0d03b505d216
---
