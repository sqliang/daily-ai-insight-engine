...
tldr: AReaL 2.0 于 2026 年 7 月 2 日正式发布，由蚂蚁集团、清华大学和香港科技大学等团队联合开发。该版本面向已上线 Agent 提供在线强化学习基础设施，让
  Agent 在真实任务中持续学习并优化底层模型。
objective_summary: 2026 年 7 月 2 日，开源强化学习基础设施项目 AReaL 正式发布 2.0 版本。该版本由蚂蚁集团、清华大学和香港科技大学等团队开发，面向已进入真实业务场景的
  Agent 提供在线强化学习训练支持。Agent 在真实任务中产生的交互轨迹可通过 AReaL 2.0 的统一推理入口被记录并接入后续训练，用于持续优化底层模型。AReaL
  项目于 2024 年发起，2026 年 5 月从蚂蚁 InclusionAI 孵化成为独立开源社区，并加入 PyTorch Foundation Ecosystem。
...
entities:
  ...
  key_people: []
key_logic_flow:
- AReaL 2.0 于 2026 年 7 月 2 日正式发布，是由蚂蚁集团、清华大学和香港科技大学等团队于 2024 年发起的开源强化学习基础设施项目的最新版本。
- AReaL 2.0 面向已进入真实业务场景的 Agent，提供了一套让 Agent 在使用中持续学习的在线强化学习系统基础设施。
- Agent 在完成真实任务时产生的交互过程可通过 AReaL 2.0 被记录、整理并接入后续训练流程，用于持续优化底层模型。
- 开发者只需让 Agent 的请求经过 AReaL 2.0 的统一推理入口即可接入在线强化学习流程，无需重新开发 Agent。
- AReaL 2.0 引入了面向 Agent 轨迹的数据代理机制，让真实任务数据在更安全可控的前提下被管理和使用。
- 2026 年 5 月，AReaL 从蚂蚁 InclusionAI 孵化成为独立开源社区，并加入 PyTorch Foundation Ecosystem 项目。
extract_result: success
object_mentions:
- object_type: project
  name: AReaL 2.0
  canonical_name: AReaL
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - AReaL 2.0 面向已进入真实业务场景的 Agent，提供了一套让 Agent 在使用中持续学习的系统基础设施。
  - AReaL 项目由蚂蚁集团、清华大学和香港科技大学等团队于 2024 年发起，2026 年 5 月加入 PyTorch Foundation Ecosystem
    项目。
  - AReaL 2.0 在系统设计中引入了面向 Agent 轨迹的数据代理机制，让真实任务数据在更安全可控的前提下被管理和使用。
  article_id: 803405008712a7ab
- object_type: project
  name: Hermes Agent
  ...
  evidence_snippets:
  - 以 Hermes Agent 为例，AReaL 2.0 在后台记录它完成任务时的关键交互过程，并结合反馈信号把轨迹用于后续训练。
  article_id: 803405008712a7ab
---
