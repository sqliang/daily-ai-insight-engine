...
tldr: 群核科技三篇论文入选ECCV 2026，涵盖空间感知与推理、强化学习数据生成和物理仿真领域；联合英伟达、Adobe等提出SPEAR仿真平台，并发布Syn-GRPO数据自进化框架与WalkerBench空间智能评测基准。
objective_summary: 群核科技在ECCV 2026上有三篇论文被录用。第一篇联合Adobe、NVIDIA、Apple、Intel提出SPEAR高保真仿真平台，开放超14000个Python接口。第二篇提出Syn-GRPO数据自进化框架，可在训练中自动生成新图片。第三篇提出WalkerBench，是覆盖六大洲161座城市的真实街景空间智能评测基准，评测显示最强AI模型完成率仅24.5%。研究团队还提出Spatial-IDE框架，已在宇树G1机器人上实现零样本部署。群核科技的训练平台SpatialVerse已与字节跳动、智元机器人等企业合作。
...
entities:
  ...
  - 唐睿
key_logic_flow:
- 群核科技有三篇论文入选ECCV 2026，涵盖空间感知与推理、强化学习数据生成、高保真物理仿真三大物理AI关键领域。
- 群核科技联合Adobe、NVIDIA、Apple、Intel等提出SPEAR仿真平台，开放超14000个Python接口，支持多模态物理属性数据输出，可接入InteriorAgent等结构化三维数据集。
- 群核科技提出Syn-GRPO数据自进化框架，能在训练中自动生成全新训练图片，通过多样化图像生成模块和多样性奖励机制提升模型能力。
- 群核科技提出WalkerBench，是全球首个基于真实街景的交互式空间智能评测基准，覆盖六大洲161座城市，评测显示最强AI模型完成率仅24.5%。
- 研究团队提出Spatial-IDE框架，为AI开辟全局空间记忆模块，已在宇树G1人形机器人上完成零样本部署和公里级自主导航。
- 群核科技的SpatialVerse平台正打通数据—仿真—评测全链路，已与字节跳动、智元机器人等企业合作，并携手谷歌、英伟达等推进物理AI前沿探索。
extract_result: success
object_mentions:
- object_type: project
  name: SPEAR
  canonical_name: SPEAR
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - 群核科技联合Adobe、NVIDIA、Apple、Intel等机构提出SPEAR，探索下一代面向物理AI的高保真仿真平台。
  - SPEAR开放超过14000个原生Python接口，可同步输出深度图、表面法线、实例分割等丰富物理属性数据。
  - SPEAR可无缝接入群核科技开源的InteriorAgent、InteriorGS等结构化三维数据集，资产具备SimReady标准化物理属性。
  article_id: a378f28cd57e94dd
- object_type: project
  name: Syn-GRPO
  canonical_name: Syn-GRPO
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - Syn-GRPO提出面向强化学习的数据自进化框架，能在训练过程中自动生成全新训练图片，从根源解决训练数据匮乏问题。
  - Syn-GRPO包含多样化图像生成模块和改造后的GRPO强化学习流程，新增多样性奖励机制引导AI产出多元答案。
  article_id: a378f28cd57e94dd
- object_type: project
  name: WalkerBench
  canonical_name: WalkerBench
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - WalkerBench是全球首个基于真实街景的交互式空间智能评测基准，覆盖世界六大洲161座城市的真实街景。
  - 评测结果显示当前最强AI模型完成率只有24.5%，AI走的步数越多性能下降越明显。
  article_id: a378f28cd57e94dd
- object_type: project
  name: Spatial-IDE
  canonical_name: Spatial-IDE
  url: null
  confidence: high
  article_role: mentioned_reference
  evidence_snippets:
  - Spatial-IDE框架给AI单独开辟全局空间记忆模块，解决线性上下文和三维空间不匹配的底层缺陷。
  - Spatial-IDE在宇树G1人形机器人上完成了零样本部署，实现真实城市街道的公里级自主导航。
  article_id: a378f28cd57e94dd
- object_type: product
  name: SpatialVerse
  canonical_name: SpatialVerse
  url: null
  confidence: high
  article_role: ecosystem_context
  evidence_snippets:
  - 群核科技于2024年正式推出空间智能训练平台SpatialVerse，通过3DGS实景重建和AI三维生成双技术路线为核心。
  - SpatialVerse已与字节跳动、智元机器人、银河通用、禾赛科技等头部企业达成深度合作。
  - SpatialVerse携手谷歌、英伟达、Adobe、Apple等全球科技企业共同推进物理AI前沿技术探索。
  article_id: a378f28cd57e94dd
- object_type: dataset
  name: InteriorAgent
  canonical_name: InteriorAgent
  url: null
  confidence: medium
  article_role: mentioned_reference
  evidence_snippets:
  - SPEAR可无缝接入群核科技开源的InteriorAgent、InteriorGS等结构化三维数据集。
  article_id: a378f28cd57e94dd
- object_type: dataset
  name: InteriorGS
  canonical_name: InteriorGS
  url: null
  confidence: medium
  article_role: mentioned_reference
  evidence_snippets:
