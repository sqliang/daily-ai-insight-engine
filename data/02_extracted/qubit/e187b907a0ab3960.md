...
tldr: 涌生智能（华大智造子公司）与上海人工智能实验室联合发布ProtoPilot多智能体系统和BioLab Bench评测体系，首次实现从自然语言实验意图到湿实验物理执行的全链路闭环。ProtoPilot在第三方测评中超越OpenAI
  GPT-5.6 Sol，填补了AI真正进入实验室执行实验的行业空白。
objective_summary: 涌生智能与上海人工智能实验室于2026年7月联合发布两项成果：ProtoPilot自进化多智能体系统和BioLab Bench全流程Agent评测体系。ProtoPilot通过Orchestrator、Protocol
  Expert和Coding三个Agent协同工作，将自然语言实验意图逐层转换为实验方案、标准操作流程、设备代码并下发到物理设备执行，再根据湿实验反馈持续修正。该成果在第三方测评中超越OpenAI
  GPT-5.6 Sol。此前OpenAI、Google、Anthropic等硅谷公司在AI for Bio领域能生成实验方案但无法实际执行实验，ProtoPilot是首个打通从屏幕到实验台全链路的系统。
...
entities:
  ...
  - 黄仁勋
key_logic_flow:
- 涌生智能（华大智造子公司）与上海人工智能实验室联合发布ProtoPilot自进化多智能体系统和BioLab Bench评测体系。
- ProtoPilot通过Orchestrator Agent、Protocol Expert Agent和Coding Agent三个Agent协同工作，将自然语言实验意图逐层转化为科学方案、标准操作流程和设备可执行代码。
- ProtoPilot实现了从用户需求到湿实验物理执行的完整闭环，并根据湿实验反馈持续修正和进化。
- BioLab Bench是生命科学领域首个从用户需求到设备可执行的全流程Agent评测体系。
- ProtoPilot在第三方测评中超越了OpenAI最强旗舰模型GPT-5.6 Sol。
- 此前OpenAI、Google、Anthropic等硅谷公司在AI for Bio领域能出方案但无法真正执行实验，ProtoPilot是首个补齐实验室物理执行环节的系统。
extract_result: success
object_mentions:
- object_type: product
  name: ProtoPilot
  canonical_name: ProtoPilot
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - ProtoPilot是一个由真实实验室场景驱动的自进化多智能体系统，能够将自然语言实验意图转化为湿实验物理执行。
  - ProtoPilot在第三方测评中超越了OpenAI最强旗舰模型GPT-5.6 Sol，证明了其在实验方案生成和执行方面的领先能力。
  - ProtoPilot背后是Orchestrator Agent、Protocol Expert Agent和Coding Agent三个Agent协同工作，逐层推进从方案到代码再到设备执行的转换。
  article_id: e187b907a0ab3960
- object_type: product
  name: BioLab Bench
  canonical_name: BioLab Bench
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - BioLab Bench是生命科学领域首个从用户需求到设备可执行的全流程Agent评测体系，用于评价真实实验链路能力。
  - 该评测体系与涌生智能的真实实验室场景深度绑定，覆盖Design2Protocol和Protocol2Code的评分标准与评测工具。
  article_id: e187b907a0ab3960
- object_type: product
  name: GPT-Rosalind
  ...
  evidence_snippets:
  - OpenAI发布GPT-Rosalind，专攻药物发现和基因组学领域的研究应用。
  article_id: e187b907a0ab3960
- object_type: product
  name: Claude Science
  ...
  article_role: mentioned_reference
  evidence_snippets:
  - Anthropic上线了面向科研流程的Claude Science工作台，用于支持科学研究工作流。
  article_id: e187b907a0ab3960
- object_type: product
  name: Co-Scientist
  ...
  article_role: mentioned_reference
  evidence_snippets:
  - 谷歌推出Co-Scientist和ERA，将多Agent系统应用于科学推理流程以支持研究。
  article_id: e187b907a0ab3960
---
