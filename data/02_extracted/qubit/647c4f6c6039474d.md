...
tldr: 智象未来发布基于原生全模态架构UiT的超2000亿参数图像大模型HiDream-O1-Image-Pro，在多个基准测试中刷新SOTA；公司同时宣布半月内完成新一轮亿级融资，由深创投、金浦投资等多家机构参与。
objective_summary: 智象未来于2026年5月19日在北京举办首届开放日，正式发布基于Unified Transformer（UiT）架构的超2000亿参数原生全模态闭源图像大模型HiDream-O1-Image-Pro，该模型将图像像素、文本标记和任务条件统一纳入连续共享标记空间，在通用文生图、高保真文字渲染、图像编辑等任务中达到新SOTA。公司同时宣布完成新一轮亿级融资，深创投、金浦投资、财鑫资本、复聚资本等参与，这是半个月内的第二轮融资。智象未来已形成'模型+智能体'双轮驱动战略和'1+1+3'业务架构，涵盖HiDream系列大模型、HiHarness企业服务平台以及商业营销、影视创作和社媒创作三大应用场景。
...
entities:
  ...
  - 洪鹄
key_logic_flow:
- 智象未来在首届开放日上发布基于原生全模态架构Unified Transformer（UiT）的超2000亿参数闭源图像大模型HiDream-O1-Image-Pro，在多个基准测试中刷新SOTA。
- HiDream-O1-Image-Pro将原始图像像素、离散文本标记和任务条件统一纳入连续共享标记空间，不同于传统LDM的图像与文本分离编码方式，实现底层表征上的深度融合。
- 此前智象未来推出的8B参数开源版本HiDream-O1-Image在Artificial Analysis文生图榜单上登顶开源模型全球第一，表现超过Z-Image
  Turbo、Qwen-Image、FLUX.2 [dev]等主流开源模型。
- 智象未来在半个月内完成新一轮亿级融资，深创投、金浦投资、财鑫资本、复聚资本等多家机构参与，资本市场对原生全模态方向持续看好。
- 公司形成'模型+智能体'双轮驱动战略和'1+1+3'业务架构：底层为HiDream系列大模型，中间为HiHarness企业服务平台，上层覆盖商业营销、影视创作和社媒创作三大场景。
pipeline_stage: fact_extracted
extract_result: success
object_mentions:
- object_type: model
  name: HiDream-O1-Image-Pro
  canonical_name: HiDream-O1-Image-Pro
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - 智象未来正式发布基于新一代原生全模态模型架构Unified Transformer（UiT）打造的图像大模型HiDream-O1-Image-Pro，超两千亿参数。
  - HiDream-O1-Image-Pro在通用文生图、高保真文字渲染、多样化场景生成、图像编辑等任务中达到新的SOTA水平。
  - HiDream-O1-Image-Pro为闭源版本，超两千亿参数，在复杂文本渲染、指令编辑、多主体个性化等任务上全面树立新SOTA。
  article_id: 647c4f6c6039474d
- object_type: model
  ...
  evidence_snippets:
  - HiDream-O1-Image以8B参数开源版本在全球知名独立评测平台Artificial Analysis文生图榜单上登顶开源模型全球第一。
  - HiDream-O1-Image表现超过Z-Image Turbo、Qwen-Image、FLUX.2 [dev]等主流开源模型，并成为该榜单排名前20中公开参数量最小的模型版本。
  article_id: 647c4f6c6039474d
- object_type: project
  name: Unified Transformer (UiT)
  canonical_name: Unified Transformer (UiT)
  url: null
  confidence: medium
  article_role: ecosystem_context
  evidence_snippets:
  - HiDream-O1-Image-Pro基于新一代原生全模态模型架构Unified Transformer（UiT）打造，将图像像素、文本标记和任务条件统一纳入连续共享标记空间。
  - 原生全模态UiT架构下所有模态从初始阶段统一建模，能够真正做到任意输入支持任意输出的'Any to Any'能力。
  article_id: 647c4f6c6039474d
- object_type: product
  name: HiHarness
  canonical_name: HiHarness
  url: null
  confidence: medium
  article_role: mentioned_reference
  evidence_snippets:
  - 智象未来形成'1+1+3'业务架构，中间层为能力中台HiHarness企业服务平台。
  article_id: 647c4f6c6039474d
---
