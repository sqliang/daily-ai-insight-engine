...
tldr: Coinbase 推出基于 MCP 协议的 AI 交易代理，可在 ChatGPT 或 Claude 中运行，支持加密货币现货和衍生品交易，并通过 x402
  开放支付协议为高级研究数据按次付费。
objective_summary: 2026 年 6 月 11 日，Coinbase 发布了可通过 MCP 协议在 ChatGPT 或 Claude 中运行的 AI
  代理，能够执行加密货币现货和衍生品交易，并利用 x402 支付协议为高级研究 API 按次付费。用户可选择将代理绑定主账户或使用沙盒模式。该代理可调用 Coinbase
  Advanced 专业交易平台功能进行分析和交易。Coinbase 此前已推出 AgentKit 和 AI 助手，此次是其在 AI 代理经济领域的进一步布局。
...
entities:
  ...
  - Lincoln Murr
key_logic_flow:
- Coinbase 推出基于 MCP 协议的 AI 交易代理，可在 ChatGPT 或 Claude 中直接运行，支持执行加密货币交易并付费获取高级研究数据。
- 用户可以选择将代理绑定到主账户进行交易，或使用独立的沙盒环境运行以避免主账户风险。
- 该代理可以利用 Coinbase Advanced 专业交易平台的功能，包括 TradingView 图表分析和执行交易，支持投资组合再平衡和按投资策略自动交易。
- 代理当前支持加密货币现货和衍生品市场，Coinbase 计划未来增加股票和预测市场支持，并添加交易规模上限等自定义限制功能。
- Coinbase 利用其与 AWS、Anthropic、Circle 和 Near 合作推出的 x402 支付协议，使代理无需登录或订阅即可为研究数据和按需算力付费。
- 全球金融监管机构 FSB 已关注 AI 代理支付领域的快速发展，呼吁建立强有力的安全保障措施以降低 AI 风险。
extract_result: success
object_mentions:
- object_type: product
  name: Coinbase for Agents
  canonical_name: Coinbase for Agents
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - Coinbase 推出可通过 MCP 协议在 ChatGPT 或 Claude 中运行的 AI 代理，能够执行加密货币交易并付费获取高级研究数据。
  - 用户可选择将代理集成到主账户进行交易，或选择在独立的沙盒环境中运行。
  article_id: 72a5ab3c2f4b6c08
- object_type: product
  name: Coinbase Advanced
  canonical_name: Coinbase Advanced
  url: null
  confidence: medium
  article_role: ecosystem_context
  evidence_snippets:
  - 该代理可以使用 Coinbase Advanced 专业交易平台的功能，包括 TradingView 图表来分析市场并执行交易。
  article_id: 72a5ab3c2f4b6c08
- object_type: project
  name: AgentKit
  canonical_name: AgentKit
  url: null
  confidence: high
  article_role: mentioned_reference
  evidence_snippets:
  - Coinbase 于 2024 年推出了 AgentKit，允许开发者将自动化钱包集成到他们的应用程序中。
  article_id: 72a5ab3c2f4b6c08
- object_type: project
  ...
  article_role: ecosystem_context
  evidence_snippets:
  - Coinbase 利用与 AWS、Anthropic、Circle 和 Near 合作推出的 x402 开放支付协议，让代理无需登录或订阅即可为研究数据按次付费。
  article_id: 72a5ab3c2f4b6c08
---
