...
tldr: 德国芯片检测初创公司 QuantumDiamonds 获得欧盟批准的7600万欧元非稀释性资助和1500万欧元股权融资，用于在慕尼黑建设半导体测试设备生产基地，其量子传感技术可将芯片缺陷检测从数周压缩至两分钟。
objective_summary: QuantumDiamonds（慕尼黑工业大学衍生企业）获得欧盟委员会批准，从德国联邦经济部和巴伐利亚州获得7600万欧元非稀释性资助，并完成1500万欧元股权融资（由
  World Fund 领投，Bayern Kapital 等跟投）。该公司将利用这笔资金在慕尼黑建设半导体测试设备生产基地，总投资计划为1.78亿美元。其量子传感技术利用人造钻石的微观特性观察芯片内部电流，可在不停产的情况下两分钟内完成传统需要数周的跨层缺陷检测，且不破坏芯片。
...
entities:
  ...
  - Kevin Berghoff
key_logic_flow:
- QuantumDiamonds 是一家从慕尼黑工业大学（TUM）分拆出来的德国初创公司，专注于利用量子传感技术进行芯片缺陷检测。
- 该公司获得欧盟委员会批准的7600万欧元非稀释性资助，资金来自德国联邦经济部和巴伐利亚州。
- QuantumDiamonds 还完成了1500万欧元股权融资，由 World Fund 领投，Bayern Kapital 及多家现有投资者跟投。
- 该公司将利用这些资金在慕尼黑建设半导体测试设备生产基地，作为此前公布的1.78亿美元投资计划的一部分。
- 其量子传感技术利用人造钻石的微观量子特性观察芯片内部电流，可以同时检测所有层的缺陷而不破坏芯片。
- 该技术将传统需要数周的缺陷检测流程压缩到两分钟以内，且无需停止生产线，客户通常在数月内即可收回设备成本。
extract_result: success
object_mentions:
- object_type: company
  name: QuantumDiamonds
  canonical_name: QuantumDiamonds
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - QuantumDiamonds 是一家德国初创公司，采用量子传感技术对芯片进行缺陷检测，可将检测时间从数周缩短到两分钟。
  - 该公司获得欧盟委员会批准的7600万欧元非稀释性资助，并完成1500万欧元股权融资，用于在慕尼黑建设半导体测试设备生产基地。
  - QuantumDiamonds 利用人造钻石的微观量子特性观察芯片内部电流，能够同时检测所有层的缺陷而不破坏芯片。
  article_id: 92ef10198812f2a0
---
