...
tldr: Meta 正计划效仿 SpaceX 和 CoreWeave 推出云基础设施业务 "Meta Compute"，通过向外部客户出售 AI 算力和模型访问权限来收回高达
  1829 亿美元的 AI 基础设施投资。
objective_summary: 据 Bloomberg 报道，Meta 正在开发一项名为 Meta Compute 的云基础设施业务计划，拟效仿 CoreWeave
  和 AWS 的模式，向外部客户出售 AI 算力以及托管在其基础设施上的 AI 模型访问权限。该计划由基础设施负责人 Santosh Janardhan、Meta
  Superintelligence Labs 负责人 Daniel Gross 和总裁 Dina Powell McCormick 共同领导，旨在为 Meta
  高达 1829 亿美元的 AI 基础设施投入寻找商业化回报渠道，因为其自有 AI 产品（如 Meta AI 和 Llama）在财报中尚未体现为独立的显著收入来源。
...
key_logic_flow:
- Meta 正在计划推出名为 Meta Compute 的云基础设施业务，向外部客户出售 AI 算力和模型访问权限，与 AWS、Google Cloud 和 Azure
  等云服务商竞争。
- Meta 此举效仿了 SpaceX 通过 xAI 出售 Colossus 1 数据中心全部算力容量的模式，SpaceX 已先后与 Anthropic、Google
  和 Reflection AI 签署了算力租赁协议。
- Meta 已承诺在未来几年内投入 1829 亿美元用于 AI 基础设施建设，包括在俄亥俄州建设一个曼哈顿大小的数据中心，预计今年上线。
- Meta 的自有 AI 模型和服务（如 Meta AI 和 Llama）尚未在财报中披露独立营收，不构成重大收入来源，因此公司需要通过出售算力来收回大规模投资。
- Meta 考虑效仿 AWS 模式，销售托管在其 AI 基础设施上的各种模型访问权限，包括其近期推出的闭源模型 Muse Spark。
- 新业务线 Meta Compute 由基础设施负责人 Santosh Janardhan、Meta Superintelligence Labs 负责人 Daniel
  Gross 和总裁 Dina Powell McCormick 共同领导。
...
- object_type: product
  ...
  evidence_snippets:
  - Bloomberg 报道称 Meta 正在开发一项名为 Meta Compute 的云基础设施业务，计划效仿 CoreWeave 模式向客户出售 AI 算力，并效仿
    AWS 模式销售 AI 模型访问权限。
  - 新业务线 Meta Compute 由基础设施负责人 Santosh Janardhan、Meta Superintelligence Labs 负责人 Daniel
    Gross 和总裁 Dina Powell McCormick 共同领导。
  article_id: 6fcb01f9e95e7d01
- object_type: model
  name: Muse Spark
  ...
  evidence_snippets:
  - 报道称 Meta 正在考虑效仿 AWS 模式，销售托管在其 AI 基础设施上的各种 AI 模型访问权限，包括其最近推出的闭源模型 Muse Spark。
  article_id: 6fcb01f9e95e7d01
- object_type: model
  name: Llama
  ...
  article_role: mentioned_reference
  evidence_snippets:
  - Meta 的 AI 模型和服务（包括 Meta AI 和 Llama 系列）在财报中未披露独立营收，尚不构成重大的独立收入来源。
  article_id: 6fcb01f9e95e7d01
- object_type: project
  name: Colossus 1
  ...
  article_role: mentioned_reference
  evidence_snippets:
  - SpaceX 通过 xAI 与 Anthropic 签署协议，买断了 SpaceX 的 Colossus 1 数据中心全部算力容量，此后 SpaceX 还与
    Google 和 Reflection AI 签署了类似的算力租赁协议。
  article_id: 6fcb01f9e95e7d01
---
