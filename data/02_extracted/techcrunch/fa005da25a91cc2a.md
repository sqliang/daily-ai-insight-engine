...
tldr: 《粉雄救兵》明星Karamo Brown推出健康应用Kē，核心功能'AI Karamo'让用户能与他的AI数字克隆实时对话获取建议。该应用由AI初创公司Delphi提供技术支撑，提供个性化健身计划、营养指导和冥想功能，旨在辅助个人成长而非取代真实人际关系。
objective_summary: 2026年6月18日，Netflix节目《粉雄救兵》明星Karamo Brown发布名为Kē的健康应用，该应用由AI初创公司Delphi提供数字克隆技术支持，提供个性化健身计划（含指导视频）、基于家中食材的营养餐单推荐、情绪冥想和社区互助功能。核心特色'AI
  Karamo'允许用户与基于Karamo访谈和播客素材训练的AI分身实时语音对话获取建议。Brown强调该应用旨在帮助用户反思与成长，不是真实人际关系的替代品。
...
entities:
  ...
  - Karamo Brown
key_logic_flow:
- Karamo Brown 发布名为 Kē 的健康应用，提供个性化健身计划、基于家中食材的营养餐单推荐、冥想和社区互助功能。
- 该应用的核心特色是'AI Karamo'功能，让用户可以与 Karamo 的 AI 数字克隆进行实时语音对话并获取建议。
- AI 克隆功能由 AI 初创公司 Delphi 提供技术支持，基于 Karamo 的访谈、播客等公开素材训练以确保尽可能真实地代表他。
- 该应用反映了名人利用 AI 技术的趋势，Arnold Schwarzenegger 也使用 Delphi 制作了数字克隆，而 Matthew McConaughey
  等人则与 ElevenLabs 合作授权声音。
- 名人 AI 克隆也引发了担忧，包括未经授权使用名人形象的问题以及粉丝对聊天机器人产生单方面情感依赖的风险。
- Karamo Brown 强调 Kē 旨在辅助个人成长与反思，不是真实人际关系的替代品，并能在用户遇到敏感问题时引导其寻求真实支持。
...
- object_type: product
  ...
  evidence_snippets:
  - Karamo Brown 推出了名为 Kē 的健康应用，该应用提供根据用户现有设备和日程定制的个性化健身计划，并配有指导视频确保动作正确。
  - Kē 还包含基于用户家中已有食材推荐餐单的营养指导功能，以及针对不同情绪的冥想视频板块以帮助管理压力和焦虑。
  - Kē 应用内置了社区板块，用户可参与以戒酒或健康等共同经历为主题的互助小组进行交流分享。
  article_id: fa005da25a91cc2a
- object_type: product
  name: AI Karamo
  canonical_name: AI Karamo
  url: null
  confidence: high
  article_role: primary_subject
  evidence_snippets:
  - Kē 应用的'AI Karamo'功能让用户可以与 Karamo Brown 的 AI 数字克隆进行实时对话，用 Karamo 的声音获取回答和建议。
  - 该 AI 克隆由 AI 初创公司 Delphi 提供技术支持，从 Karamo 的访谈、播客和其他视频素材中提取内容以确保尽可能真实地代表他。
  - Karamo 表示他最好的朋友和姐妹至今仍会在联系不到他时与 AI 克隆交流，说明该克隆具备一定实用价值。
  article_id: fa005da25a91cc2a
- object_type: company
  name: Delphi
  canonical_name: Delphi
  url: null
  confidence: medium
  article_role: mentioned_reference
  evidence_snippets:
  - AI 克隆功能由 AI 初创公司 Delphi 提供技术支持，从 Karamo 的访谈、播客和其他视频素材中提取内容以训练数字分身。
  - 报道提到 Arnold Schwarzenegger 也使用 Delphi 技术制作了自己的数字克隆。
  article_id: fa005da25a91cc2a
---
