...
created: '2026-06-04'
description: 'This week we''ve got tandem hands-ons with Google''s new Gemini AI agent
  - Spark - from my colleagues David Pierce and Jay Peters. Their takeaways are similar:
  It''s so effective that it''s scary. Spark knew that David''s dog is named Frida
  and knew the first name of Jay''s wife, even though neither of them explicitly [&#8230;]'
tags:
- clippings
