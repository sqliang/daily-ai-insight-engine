...
tldr: 本文分析了维生素D补充剂的争议：大型随机对照试验（WHI、VITAL）未能显示维生素D对主要健康终点有显著效果，但几乎所有人体细胞都有维生素D受体且多种组织可自主转化活性维生素D的生物学发现，以及观察性研究的强相关性，仍支持低水平人群补充维生素D是合理选择。
objective_summary: 作者（dynomight博客）从生物学机制、观察性研究和随机对照试验三个维度审视维生素D补充剂的有效性争论。经典观点认为维生素D仅是调节钙吸收的骨骼激素，只要储备水平高于25
  nmol/L就无需补充。但1980年代后研究发现几乎所有细胞都有维生素D受体，且免疫细胞、心脏、皮肤等组织可自主将储备维生素D转化为活性形式。大型RCT如WHI（3.6万名绝经女性，400
  IU/天）和VITAL（2.6万名老年人，2000 IU/天）在主要终点上均未达到统计显著性，但VITAL试验中自身免疫性疾病风险比为0.78（达到统计显著性），且多项meta分析显示对基线维生素D低水平人群有微弱益处。作者结合生物学机制和进化论视角，认为低水平人群补充维生素D仍是合理选择。
...
entities:
  ...
  - Frank Garland
key_logic_flow:
- 经典观点认为维生素D仅是通过肾脏调控钙吸收的骨骼激素，只要血液储备维生素D高于25 nmol/L，肾脏就能按需制造活性维生素D，补充剂应该无效。
- 1980年Cedric和Frank Garland发表论文提出紫外线照射和维生素D水平与结肠癌发病率呈负相关，此后大量观察性研究发现维生素D水平与多种癌症、心血管疾病、糖尿病等健康结局呈强相关性。
- 1980年代发现几乎所有人体细胞都有维生素D受体，1990年代发现多种组织（免疫细胞、心脏、皮肤等）拥有将储备维生素D转化为活性形式的酶，说明维生素D的作用远超骨骼调节。
- WHI试验（3.6万人）和VITAL试验（2.6万人）等大型随机对照试验未能在主要终点上达到统计显著性，但VITAL试验在自身免疫性疾病方面显示出显著效果（风险比0.78）。
- 作者认为结合生物学机制、进化论视角和RCT亚组分析，低水平人群补充维生素D仍是合理的保守选择，但对此结论并非绝对确定。
extract_result: success
object_mentions:
- object_type: paper
  name: Women's Health Initiative (WHI) trial
  canonical_name: WHI vitamin D trial
  url: null
  confidence: high
  article_role: mentioned_reference
  evidence_snippets:
  - WHI试验招募了3.6万名美国绝经后女性，一半每天服用400 IU维生素D加钙剂，另一半服用安慰剂，持续七年后所有主要终点的风险比均未达到统计显著性。
  - WHI试验中维生素D组肾结石风险比为1.17（1.02至1.34），是唯一达到统计显著性的结果，但这是一个负面结果。
  article_id: eca7be2f82af2744
- object_type: paper
  name: VITAL trial
  canonical_name: VITAL vitamin D trial
  url: null
  confidence: high
  article_role: mentioned_reference
  evidence_snippets:
  - VITAL试验招募了2.6万名美国老年人（20%为黑人），治疗组每天服用2000 IU维生素D，5.3年后自身免疫性疾病风险比为0.78（0.61至0.99），达到了统计显著性。
  - VITAL试验中主要心血管事件风险比为0.97（0.85至1.12），癌症死亡风险比为0.83（0.67至1.02），均未达到统计显著性。
  article_id: eca7be2f82af2744
- object_type: paper
  name: Do Sunlight and Vitamin D Reduce the Likelihood of Colon Cancer?
  canonical_name: Garland 1980 colon cancer sunlight paper
  url: null
  confidence: medium
  article_role: mentioned_reference
  evidence_snippets:
  - Cedric和Frank Garland于1980年发表论文，提出紫外线照射→维生素D→血钙充足→结肠上皮细胞炎症减少→结肠癌减少的因果机制链条。
  - 该论文曾被多次拒稿后才得以发表，作者认为这篇论文本可以成为一篇精彩的博客文章。
  article_id: eca7be2f82af2744
---
