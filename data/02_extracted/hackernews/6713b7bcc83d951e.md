...
tldr: 欧盟议会通过了允许无差别大规模扫描私人通信的临时法规（Chat Control 1.0），有效期至2028年。尽管投票议员中多数反对（314票反对、276票赞成），但因未达到否决所需的361票绝对多数，该法案仍被通过。
objective_summary: 2026年7月17日，欧盟议会通过了允许科技公司在无司法授权和缺乏嫌疑的情况下扫描用户私信的临时法规Chat Control
  1.0，有效期至2028年。该法案曾在3月被两次否决，此次虽然投票议员中多数反对（314票反对、276票赞成、17票弃权），但否决动议未达到361票的绝对多数门槛，因而未能阻止通过。端到端加密通信被象征性豁免——实际上此类通信此前也未被扫描。支持者将该措施描述为儿童保护手段，但批评者指出过去五年中该系统产生了大量误报，且欧盟委员会承认没有证据表明无差别扫描提高了定罪率或救助儿童的数量。
...
entities:
  ...
  - Dorothée Hahne
key_logic_flow:
- 欧盟议会通过了Chat Control 1.0临时法规，允许对私人通信进行无差别大规模扫描，有效期至2028年或永久法规达成协议为止。
- 尽管投票议员中多数反对该法案（314票反对、276票赞成），但因否决动议未达到361票的绝对多数，法案仍被通过。
- 端到端加密通信（如WhatsApp）被象征性豁免，但事实上此类通信此前也未被扫描过。
- 批评者指出该系统的多个缺陷：2024年仅有36%的举报来自私信扫描、48%的警报无刑事相关性、40%的调查实际针对未成年人、Meta生成的99%举报为已知旧材料。
- 欧盟委员会承认没有证据表明无差别扫描提高了刑事定罪率或救助了儿童。
- 永久法规（Chat Control 2.0）谈判将于9月重启，核心分歧在于扫描应无差别进行还是只针对犯罪嫌疑人。
