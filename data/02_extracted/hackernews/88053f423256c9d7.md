...
tldr: 欧盟存在两项并行推进的"Chat Control"立法：Chat Control 1.0（临时自愿扫描私信制度，已于2026年4月到期）和Chat Control
  2.0（永久性强制扫描提案，仍在谈判中）。理事会正以罕见紧急程序试图复活已失效的Chat Control 1.0，议会需在2026年7月9日投票中以361票绝对多数才能阻止该复活提案自动通过。
objective_summary: 欧盟并行推进两项涉及私信扫描的立法。Chat Control 1.0（Regulation (EU) 2021/1232）是允许服务商自愿扫描用户私信以检测儿童性虐待材料的临时法律，已于2026年4月4日到期。2026年3月欧洲议会以311票反对、228票赞成的结果拒绝延期后，欧盟理事会提出一份内容相同的"新法"试图复活该制度。议会在2026年7月初以331票对303票批准紧急程序跳过委员会审议，7月9日将进行具有约束力的投票，需361票绝对多数才能阻止或修改该复活提案。同时，Chat
  Control 2.0（CSA Regulation）作为永久性提案要求平台强制检测并报告儿童性虐待内容，经过五轮三方谈判仍未达成协议。加密扫描是核心争议：议会坚持扫描须经法院令授权并针对特定嫌疑人，而理事会推动无嫌疑的自愿扫描。
...
entities:
  ...
  - Ylva Johansson
key_logic_flow:
- 欧盟存在两项并行的"Chat Control"立法：Chat Control 1.0是允许服务商自愿扫描私信的临时法律，已于2026年4月4日到期；Chat Control
  2.0是要求平台强制检测儿童性虐待内容的永久性提案，尚未达成协议。
- Chat Control 1.0到期前，欧洲议会2026年3月以311票反对、228票赞成的结果拒绝延长该法律，关键的修正案34仅以307票对306票的一票优势通过，否定了对未知照片和文本的自动评估。
- 该法律到期后，Google、Meta、Microsoft和Snap声明将无视法律到期，继续扫描用户私信。
- 欧盟理事会提出一份内容与已失效法律完全相同的"新法"，试图通过紧急程序绕过议会的否决将其复活，这在欧盟立法史上前所未有。
- Chat Control 2.0经过五轮三方谈判均未达成协议，2026年6月29日被标榜为"最终轮"的谈判因无嫌疑扫描问题破裂，谈判在爱尔兰轮值主席国下继续。
- 议会于2026年7月以331票对303票批准紧急程序加快处理Chat Control 1.0复活提案，绕过负责委员会直接进入投票阶段，7月9日的约束性投票需361票绝对多数才能阻止该法律自动通过。
