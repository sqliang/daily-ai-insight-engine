...
tldr: 前 Go 安全团队负责人 Filippo Valsorda 在 2026 年撰文指出，由于 LLM 发现漏洞的能力已与大多数安全研究人员相当，洞察力不再稀缺，任何人都能运行
  LLM 寻找潜在问题，漏洞报告的特殊性已不复存在。安全工作的瓶颈从发现漏洞转向评估真实性，保密性和协调披露的重要性下降，安全团队应将精力集中在分类、快速修复和预防上。
objective_summary: 前 Go 安全团队负责人 Filippo Valsorda 于 2026 年在其个人博客发文，认为 LLM 的出现从根本上改变了漏洞报告的性质。他指出
  LLM 发现漏洞的能力已与大多数安全研究人员相当，洞察力不再稀缺，任何人都可以运行 LLM 寻找潜在问题，维护者面临的核心挑战从发现漏洞转变为评估哪些报告是真实的。保密性和协调披露的价值也随之下降，因为攻击者同样可以使用
  LLM 发现漏洞，无需阅读公开披露文章。Valsorda 建议安全团队应将重点转向分类、快速修复和在 CI 中集成 LLM 分析，同时承认极高严重性或来自高度可信来源的报告仍需要特殊处理。
...
entities:
  ...
  - Juho Forsén
key_logic_flow:
- 过去，漏洞报告被视为特殊的，因为安全研究人员为维护者提供稀缺的洞察力和保密性，帮助他们在攻击者利用漏洞之前完成修复。
- 截至 2026 年，LLM 的能力已与大多数安全研究人员相当，任何人都可以运行 LLM 来发现潜在漏洞，这使得洞察力不再稀缺和珍贵。
- 漏洞发现的瓶颈已从发现潜在问题转变为评估哪些报告是真实的，外部研究人员无法有效参与这一分类过程。
- 保密性和协调披露的重要性大幅下降，因为攻击者同样可以使用自己的 LLM 发现漏洞，不再需要阅读公开披露文章。
- 安全团队的新职责是分类、快速修复和预防，包括在 CI 中运行 LLM 分析来主动发现漏洞。
- 极高严重性的漏洞报告或来自高度可信来源的报告仍然需要特殊处理，安全团队需要快速将报告区分为特殊和非特殊两类。
extract_result: success
object_mentions:
- object_type: company
  name: Geomys
  canonical_name: Geomys
  url: null
  confidence: medium
  article_role: mentioned_reference
  evidence_snippets:
  - Geomys 是一个由专业 Go 语言维护者组成的组织，通过提供 retainer 合同确保开源维护工作的可持续性。
  - Geomys 的赞助方包括 Ava Labs、Teleport、Datadog、Tailscale 和 Sentry，文章作者的工作正是由 Geomys 支持的。
  article_id: 31d0a00892d3fcca
- object_type: project
  name: Go
  canonical_name: Go
  url: null
  ...
  evidence_snippets:
  - 作者曾担任 Go 安全团队的负责人，负责处理 Go 项目的安全漏洞和协调披露流程。
  - 作者离开 Google 后仍参与 Go 项目的维护工作，但明确表示文章观点不代表 Go 安全团队的官方立场。
  article_id: 31d0a00892d3fcca
---
