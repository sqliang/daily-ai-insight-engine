...
- object_type: product
  ...
  canonical_name: DaVinci Resolve 21
  url: https://www.blackmagicdesign.com/products/davinciresolve/whatsnew
  positioning: Blackmagic Design 推出的专业视频剪辑、调色与音频后期软件，最新版本新增 Photo 页面将好莱坞级调色能力扩展至静态摄影领域，并集成多项
    AI 驱动工具。
  ...
  - 摄影师
  - 影视后期制作团队
  product_signal: 新增 Photo 页面支持 RAW 格式编辑和色板调色，集成 AI IntelliSearch、AI 语音合成、AI 面部年龄变换和瑕疵去除等多项
    AI 工具。
  market_signal: 作为全球广泛使用的专业影视后期软件的重要版本更新，新增静态摄影功能和 AI 工具集有望进一步扩大其用户覆盖范围。
  differentiation: 将好莱坞级节点式调色工作流引入静态摄影领域，在一款软件中集成 AI 搜索、面部变换、语音合成等多项 AI 能力，覆盖剪辑、调色、合成、音频全流程。
  watch_reason: DaVinci Resolve 21 将专业调色能力拓展至静态摄影全新领域，并集成多项实用 AI 工具，可能变革专业后期制作工作流，其市场采纳情况和新功能实际使用效果值得长期跟踪。
  risk_notes:
  - 新增的 AI 面部年龄变换和面部重塑功能在影视后期中实用性强，但可能引发深度伪造相关的伦理争议和监管风险。
  - 新增 AI 功能在专业影视工作流中的实际可靠性和准确度尚需大规模用户验证，尤其是面部变换和年龄调整的一致性与可控性。
  score: 8.0
  article_ids:
  - 0145e36877896c55
  evidence_snippets:
  - DaVinci Resolve 21 新增 Photo 页面，将好莱坞最先进的节点式调色工具首次引入静态摄影领域，并支持 RAW 格式编辑与相机联机拍摄。
  - 该版本引入 AI IntelliSearch 智能搜索、AI CineFocus 景深控制、AI Face Age Transformer 面部年龄变换、AI
    语音合成和 AI Blemish Removal 瑕疵去除等多项人工智能驱动的后期制作工具。
  - Fusion 页面集成 Krokodove 工具集，新增超过 70 种实用图形效果和可定制 2D 与 3D 图形模板供用户使用，并更新 USD 工具集至 SDK
    25.11 以支持 Hydra 2.0 API。
- object_type: project
  name: Krokodove
  canonical_name: Krokodove
  url: null
  positioning: 一个被 DaVinci Resolve 21 官方集成的第三方 Fusion 合成工具库，提供超过 70 种实用图形效果以及可定制的
    2D 和 3D 图形模板，拥有活跃的社区生态。
  technical_signal: 工具集包含实用工具、矢量和数据工具以及可定制的 2D 和 3D 图形模板，为 Fusion 合成页面新增超过 70 种图形效果，扩展了
    DaVinci Resolve 的视觉特效能力。
  adoption_signal: 被官方描述为'人气旺盛且不断增长的合成工具库'，并被 Blackmagic Design 官方集成到 DaVinci Resolve
    21 的 Fusion 合成页面中作为核心工具集。
  ecosystem_relevance: 被 DaVinci Resolve 21 官方集成作为 Fusion 页面核心工具集，显著扩展了该软件在视觉特效和合成方面的能力，丰富了
    Blackmagic Design 后期制作生态。
  target_users: []
  product_signal: null
  market_signal: null
  differentiation: null
  watch_reason: Krokodove 作为被 DaVinci Resolve 官方集成的第三方合成工具库，提供了超过 70 种图形效果和可定制模板，其工具生态的持续增长态势和社区活跃程度十分值得长期跟踪关注。
  risk_notes:
  - 作为第三方工具被集成到 DaVinci Resolve 中，未来版本兼容性和官方维护的持续性存在不确定性。
  score: 5.0
  article_ids:
  - 0145e36877896c55
  evidence_snippets:
  - Fusion 页面现在集成了 Krokodove，这是一个人气旺盛且不断增长的合成工具库，包含超过 70 种图形效果供用户使用。
  - Krokodove 工具集包含实用工具、矢量和数据工具以及可定制的 2D 和 3D 图形模板，被官方集成到 DaVinci Resolve 21 的 Fusion
    合成页面中供用户使用。
- object_type: project
  name: Fairlight Animator
  canonical_name: Fairlight Animator
  url: null
  positioning: DaVinci Resolve 21 中连接 Fusion 合成页面与 Fairlight 音频引擎的修饰器工具，通过音频分析驱动面部参数控制实现自动动画效果。
  technical_signal: 利用时间线片段或媒体池源素材的音频电平驱动眼睛和嘴唇等面部参数控制，实现基于音频内容的自动化动画，将 Fusion 与 Fairlight
    音频引擎原生连接。
  adoption_signal: null
  ecosystem_relevance: 作为 DaVinci Resolve 21 中 Fairlight 音频引擎与 Fusion 合成系统之间的桥梁工具，扩展了音频驱动动画的创作能力，丰富了软件内部模块间的协同工作流。
  target_users: []
  product_signal: null
  market_signal: null
  differentiation: null
  watch_reason: Fairlight Animator 作为 DaVinci Resolve 中连接音频引擎与合成系统的创新工具，探索了音频驱动自动动画的新方向，其在专业内容创作中的实际应用效果和普及程度值得持续关注。
  risk_notes:
  - 依赖音频分析的自动动画在复杂场景中的准确度和可控性可能有限，需要大量手动微调。
  - 该工具仅在 DaVinci Resolve 21 发布说明中提及，在实际工作流中的成熟度和用户接受度有待市场检验。
  score: 4.0
  article_ids:
  - 0145e36877896c55
  evidence_snippets:
  - Fairlight Animator 修饰器将 Fusion 连接到 Fairlight 音频引擎，可基于音频分析实现自动动画，利用音频电平驱动眼睛和嘴唇等参数控制。
  - Fairlight Animator 利用时间线片段或媒体池源素材的音频电平驱动眼睛和嘴唇等参数控制，实现基于音频内容的自动化动画效果。
---
