...
tldr: 超340家美国本地新闻媒体因担忧AI公司抓取训练数据而限制Internet Archive的网络爬虫访问
objective_summary: 2025年1月至5月，Nieman Lab调查发现限制Internet Archive爬虫的新闻网站从241家增至382家，其中342家为本地新闻媒体（93%位于美国）。五大本地新闻出版巨头（USA
  Today Co.、McClatchy、Advance Local、MediaNews
...
entities:
  ...
  - Anna Bross
key_logic_flow:
- 2025年1月Nieman Lab首次披露主要新闻出版商因AI训练数据风险开始屏蔽Internet Archive，至5月限制爬虫的新闻网站从241家增至382家
- 新增屏蔽网站中342家为本地新闻媒体（93%位于美国），主要归属于USA Today Co.、McClatchy、Advance Local、MediaNews
  Group和Tribune Publishing五大本地新闻出版集团，后两家均为Alden Global Capital子公司
- Advance Local于2025年8月开始主动屏蔽Internet Archive，承认此举为预防性措施，并无证据表明其内容已被AI公司通过Wayback
  Machine抓取
- Alden Global Capital于2025年7月在旗下60多家报纸发表社论批评OpenAI等AI公司无偿使用新闻内容训练模型，其子公司MediaNews
  Group和Tribune Publishing已加入对OpenAI和Microsoft的版权侵权诉讼
- 部分独立出版商（如The Baltimore Banner）的动机并非阻止AI引用，而是担忧Wayback Machine作为'后门'会导致AI产品无法正确标注信息来源和原始出处
- Internet Archive创始人Mark Graham回应称已实施限流下载、与Cloudflare合作监控爬虫等措施，并强调其使用条款仅允许学术研究用途
